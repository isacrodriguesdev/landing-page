export default function Card() {
  return (
    <section className="bg-black flex justify-center items-center xsm:pt-40 2sm:pt-0">
      <div className="sm:grid md:flex relative isolate px-4 overflow-hidden pt-10 bg-black rounded-xl lg:w-9/12 mx-auto">
        <div className="mx-auto lg:gap-20 justify-center place-self-center">
          <div className="mx-auto max-w-4xl lg:mx-0">
            ...
            <p className="mt-6 text-xl leading-8 text-gray-300 font-sans">
        ...
        <div className="px-4 sm:px-6 w-72 lg:px-8 mx-auto pt-14">
