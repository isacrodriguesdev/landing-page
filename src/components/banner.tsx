...
export default function Banner() {
  return (
<main className="w-full h-4/5 bg-secundary relative isolate overflow-hidden">
      <div
      ...
      <div className="grid 2sm:px-4 3sm:px-4 md:px-0 lg:gap-8 xl:gap-0 lg:grid-cols-12">
        <div className="max-w-3xl lg:ml-20 mr-auto place-self-center lg:col-span-7">
          ...
          <p className="lg:ml-5 font-sans sm:text-center lg:text-start xl:text-2xl text-gray-100 lg:mb-8 md:text-xl lg:text-md mt-8 mb-8">
            Encontre os profissionais preparados para os desafios da sua empresa
            ou projeto de forma simples e eficiente!
          </p>
          <div className="flex sm:justify-center lg:justify-normal">
          <a
            href="#"
