...
export default function Banner() {
  return (
<main className="w-full bg-gradient-to-tr from-primary to-secundary relative isolate overflow-hidden 3xl:mt-6 xl:mt-4 2xl:mt-0">
      <div
      ...
      <div className="grid 2sm:px-4 3sm:px-4 md:px-0 lg:gap-8 xl:gap-0 lg:grid-cols-12 justify-center">
        <div className="max-w-3xl lg:ml-20 mr-auto place-self-center lg:col-span-7 ">
          ...
          <p className="lg:ml-5 font-sans sm:text-center lg:text-start xl:text-2xl text-gray-100 lg:mb-8 md:text-xl lg:text-dm mt-8 mb-8">
